import 'package:cn1_d_wallet/pages/withdraw/withdraw-success.dart';
...
class WithdrawAmountScreen extends StatefulWidget {
  ...
  @override
  State<WithdrawAmountScreen> createState() => WithdrawAmountScreenState();
}

class WithdrawAmountScreenState extends State<WithdrawAmountScreen> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              onChanged: (value) {
                Provider.of<WithdrawProvider>(context, listen: false).amount =
                    int.parse(value);
              },
              ...
              onTap: () async {
                ...
                bool? checkWithdraw =
                    await TransactionService(context: context, prefs: prefs)
                        .withdraw(localBankId, amount);
                if (checkWithdraw != null && checkWithdraw) {
